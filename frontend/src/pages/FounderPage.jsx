...
const FounderPage = () => {
  ...
  const skills = [
    ...
    { category: "Frontend", items: ["React.js", "React Native", "Next.js", "Expo"] },
    { category: "Backend", items: ["Node.js", "REST APIs", "Strapi CMS"] },
    { category: "Database", items: ["MySQL", "PostgreSQL", "Firebase", "Cloud Firestore"] },
    { category: "Tools", items: ["Postman", "GitHub", "Docker", "Ant Design"] },
  ]
  ...
  <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-8 rounded-t">
    <div className="flex items-center gap-6">
      ...
      <div>
        <h1 className="font-bold text-3xl mb-2">Kartikey Septa</h1>
        <p className="text-blue-100 text-lg">Full Stack & Software Engineer</p>
        <p className="text-blue-200 text-sm">Creator of Sārathi AI Blog Generator</p>
      </div>
    </div>
  </div>
  <div className="p-6">
